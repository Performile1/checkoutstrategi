      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li className="card"><strong className="flex items-center gap-2"><Sparkles size={16} className="text-brand-500" /> Checkout-konsultation</strong><p className="mt-2 text-slate-600 dark:text-slate-400">30 minuter där vi går igenom din nuvarande kassa och identifierar top-3 konverteringslevers.</p></li>
