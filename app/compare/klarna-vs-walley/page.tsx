...
export const metadata: Metadata = {
  title: 'Klarna vs Walley - Jämförelse 2025 | Checkoutstrategi',
  description: 'Jämför Klarna och Walley som checkout-leverantörer. Se priser, funktioner, integrationer och recensioner för att hitta rätt lösning för din e-handel.',
  openGraph: {
    title: 'Klarna vs Walley - Jämförelse',
    description: 'Detaljerad jämförelse av Klarna och Walley för svenska e-handlare.',
    type: 'article',
  },
  alternates: {
    canonical: 'https://checkoutstrategi.se/compare/klarna-vs-walley',
  },
};

export default function KlarnaVsWalleyPage() {
  const player1 = players.find(p => p.slug === 'klarna');
  const player2 = players.find(p => p.slug === 'walley');
