...
export const metadata: Metadata = {
  title: 'Klarna vs Qliro - Jämförelse 2025 | Checkoutstrategi',
  description: 'Jämför Klarna och Qliro som checkout-leverantörer. Se priser, funktioner, integrationer och recensioner för att hitta rätt lösning för din e-handel.',
  openGraph: {
    title: 'Klarna vs Qliro - Jämförelse',
    description: 'Detaljerad jämförelse av Klarna och Qliro för svenska e-handlare.',
    type: 'article',
  },
  alternates: {
    canonical: 'https://checkoutstrategi.se/compare/klarna-vs-qliro',
  },
};

export default function KlarnaVsQliroPage() {
